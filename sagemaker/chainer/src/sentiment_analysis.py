...
if __name__ == '__main__':
    ...
    trainer.extend(extensions.PrintReport(
        ['epoch', 'main/loss', 'validation/main/loss',
         'main/accuracy', 'validation/main/accuracy', 'main/f1', 'validation/main/f1',
         'main/precision', 'validation/main/precision', 'main/recall', 'validation/main/recall', 'elapsed_time']))
...
def output_fn(prediction_output, accept):
    ...
    if accept == 'application/json':
        lists = prediction_output.tolist()
